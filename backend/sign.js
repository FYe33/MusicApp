...
!(function (n, t) {
  ...
  n.__sign_hash_20200305 = function (n) {
    ...
    function t (n) {
      return (function (n) {
        ...
        n[t >> 5] |= 128 << t % 32,
        n[14 + (t + 64 >>> 9 << 4)] = t
        let o; let e; let u; let p; let i; let r = 1732584193; let f = -271733879; let h = -1732584194; let c = 271733878
    ...
    return (function (n) {
      let t; let o; const e = '0123456789abcdef'; let u = ''
  ...
  (function r (f, h, c, l, g) {
    ...
    function () {
      const n = g[g.length - 2]
      const t = Object.getOwnPropertyDescriptor(n[0], n[1]) || {
        configurable: !0,
        enumerable: !0
      }
      t.get = g[g.length - 1],
    ...
    function () {
      ...
      for (let i = 0; i < t; i++) { p[i] = c[h++] }
      g.push(function n () {
        const t = u.slice(0)
        t[0] = [this],
        t[1] = [arguments],
        t[2] = [n]
        for (let o = 0; o < p.length && o < arguments.length; o++) { p[o] > 0 && (t[p[o]] = [arguments[o]]) }
        return r(f, e, c, l, t)
      })
    },
    function () {
